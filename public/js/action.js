               ...
               $.each(id_value, function(i,value){
                   ...
                   if(check.attr('data-id') == response.data['self_request_name']){
                       check.attr('style', 'background-color: rgb(217,181,81) !important');
                        check.html('<img src="../images/star.png" class="mr-2 star_left" width="30" height="30" alt="">' + display + '<img src="../images/right_arrow.png" width="30" height="30" class="menu_arrow" alt="">');
                   } else {
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            if(response.data['self_request_name'] == ""){
                ...
                $('#' + response.data['self_request_name']).html('<img src="../images/star.png" class="mr-2 star_left" width="30" height="30" alt="">' + text_dis + '<img src="../images/right_arrow.png" width="30" height="30" class="menu_arrow" alt="">');
            }
        }
    });
