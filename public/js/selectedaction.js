                ...
                if(data_active.length > 1){
                    ...
                    $.each(data_active, function(i,e_active){
                        ...
                        if(isIOS){
                            ...
                            var url = `intent://calendar.google.com/calendar/eventedit?text=`+ e_active['title'] +`&dates=`+ e_active['utc_start'] + `/`+ e_active['utc_end'] +`&details=`+ e_active['description'] +`&location=`+ e_active['location'] + `#Intent;package=com.google.android.calendar;scheme=https;end`;
                        } else {
