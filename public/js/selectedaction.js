                ...
                if(data_active.length > 1){
                    ...
                    $.each(data_active, function(i,e_active){
                        ...
                        if(isIOS){
                            ...
                            var url = `https://com.google.calendar?action=create&title=`+ e_active['title'] + `&description=`+ e_active['description'] +`&dates=`+ e_active['utc_start'] + `/`+ e_active['utc_end'] +`&location=`+ e_active['location'] + `#Intent;package=com.google.android.calendar;scheme=https;end`;
                            $('#e_body').append(`
                            <div class="col-md-12">
                                <div class="card" style="background-image: url(`+ e_active['image'] +`); background-size:cover; border-raidus: 10% !important; border: 2px solid rgb(217,181,81);">
                                    <div class="card-body">
